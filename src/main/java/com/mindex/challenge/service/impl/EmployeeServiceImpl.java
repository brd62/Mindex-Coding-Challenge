...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public ReportingStructure calculateReportingStructure(String id) {
        LOG.debug("Calculating report structure for employee [{}]", id);
        ...
        Integer totalReports = employee.getDirectReports().size();
        for (Employee report : employee.getDirectReports()) {
            totalReports += calculateReportingStructure(report.getEmployeeId()).getNumberOfReports();
        }
